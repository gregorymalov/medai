...
class TranscriptionRequest(BaseModel):
    audio_filename: str = Field(..., description="Имя файла в папке audio для транскрибации")
    phone: Optional[str] = Field(None, description="Номер телефона для имени файла результата")
